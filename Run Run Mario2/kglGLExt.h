...
Copy the kglGLExt.h to your compiler's include/GL/ directory 
Copy kglGLExt.lib to your compiler's lib/ directory. 
Include "kglGLExt.h" in your project 
In your project settings tell VC to link with kglGLExt.lib. 
Alternative way: include kglGLExt.c in your project. 
In your program, after creating the rendering context, call glInitialize() function. It should return 0, if not then something went wrong. 
